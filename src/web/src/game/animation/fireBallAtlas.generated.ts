...
export const FIREBALL_BODY_RATIO = 0.75275 as const;

/** Every frame shares this source box, so one origin works for all of them. */
export const FIREBALL_FRAME_SIZE = { width: 341, height: 182 } as const;

/** Origin on the body centre and its vertical centre. */
export const FIREBALL_ANCHOR = { x: 0.55132, y: 0.50000 } as const;
