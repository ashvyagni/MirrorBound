...
export const FIREBALL_BODY_RATIO = 0.78802 as const;

/** Every frame shares this source box, so one origin works for all of them. */
export const FIREBALL_FRAME_SIZE = { width: 404, height: 217 } as const;

/** Origin on the body centre and its vertical centre. */
export const FIREBALL_ANCHOR = { x: 0.50248, y: 0.49770 } as const;
